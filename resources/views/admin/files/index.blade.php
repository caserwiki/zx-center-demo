...
<div class="zx-box custom-data-table dt-bootstrap4">
                ...
                <li>
                    ...
                    <div class="mailbox-attachment-info">
                        <div class="d-flex justify-content-between item">
                            <span
                                class="mailbox-attachment-name">{!! $grid->columns()->get('id')->getLabel() !!}</span> {!! $row->column('id') !!}
                        </div>
                        ...
                        <span class="d-flex justify-content-between" style="margin-top: 5px">
                            {!! $row->column(Zx\Admin\Grid\Column::SELECT_COLUMN_NAME) !!}
                            <div>{!! $row->column(Zx\Admin\Grid\Column::ACTION_COLUMN_NAME) !!}</div>
                        </span>
                    </div>
                </li>
            @endforeach
